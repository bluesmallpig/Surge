...
return new Promise((resolve, reject) => {
  let watch_videourl ={
    url: `https://api3-normal-c-hl.amemv.com/luckycat/aweme/v1/task/done/read?${readheader}`,
...
return new Promise((resolve, reject) => {
  let withdrawurl ={
    url: `https://api3-normal-c-hl.amemv.com/luckycat/aweme/v1/wallet/take_cash?task_key=jiao_take_cash&${signheader}`,
    headers: JSON.parse(readkey),
    body: `{
