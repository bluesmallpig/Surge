...
#圈x
[rewrite local]
https://(aweme-\w+|aweme).snssdk.com/luckycat/aweme/v1/task/sign_in/detail? url script-request-header https://raw.githubusercontent.com/bluesmallpig/Surge/master/Scripts/dyjsb.js
https://(aweme-\w+|aweme).snssdk.com/luckycat/aweme/v1/task/done/read? url script-request-header https://raw.githubusercontent.com/bluesmallpig/Surge/master/Scripts/dyjsb.js
https://(aweme-\w+|aweme).snssdk.com/luckycat/aweme/v1/task/walk/step_submit? url script-request-header https://raw.githubusercontent.com/bluesmallpig/Surge/master/Scripts/dyjsb.js
#loon
http-request ^https://(aweme-\w+|aweme).snssdk.com/luckycat/aweme/v1/task/sign_in/detail? script-path=https://raw.githubusercontent.com/bluesmallpig/Surge/master/Scripts/dyjsb.js, requires-body=true, timeout=10, tag=抖音极速版sign
http-request ^https://(aweme-\w+|aweme).snssdk.com/luckycat/aweme/v1/task/done/read? script-path=https://raw.githubusercontent.com/bluesmallpig/Surge/master/Scripts/dyjsb.js, requires-body=true, timeout=10, tag=抖音极速版read
http-request ^https://(aweme-\w+|aweme).snssdk.com/luckycat/aweme/v1/task/walk/step_submit? script-path=https://raw.githubusercontent.com/bluesmallpig/Surge/master/Scripts/dyjsb.js, requires-body=true, timeout=10, tag=抖音极速版step
#surge
dyjsbsign = type=http-request,pattern=^https://(aweme-\w+|aweme).snssdk.com/luckycat/aweme/v1/task/sign_in/detail?,requires-body=1,max-size=0,script-path=https://raw.githubusercontent.com/bluesmallpig/Surge/master/Scripts/dyjsb.js,script-update-interval=0
dyjsbread = type=http-request,pattern=^https://(aweme-\w+|aweme).snssdk.com/luckycat/aweme/v1/task/done/read?,requires-body=1,max-size=0,script-path=https://raw.githubusercontent.com/bluesmallpig/Surge/master/Scripts/dyjsb.js,script-update-interval=0
dyjsbstep = type=http-request,pattern=^https://(aweme-\w+|aweme).snssdk.com/luckycat/aweme/v1/task/walk/step_submit?,requires-body=1,max-size=0,script-path=https://raw.githubusercontent.com/bluesmallpig/Surge/master/Scripts/dyjsb.js,script-update-interval=0
*/
const jsname='抖音极速版'
const $ = Env(jsname)
...
return new Promise((resolve, reject) => {
  let invitatonurl ={
    ...
    headers: JSON.parse(readkey),
    body: JSON.stringify({"in_sp_time":0,"invite_code":"8802378931"})
}
